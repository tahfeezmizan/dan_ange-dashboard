...
const HomeFaq = () => {
  ...
  return (
    <div className="container mx-auto px-5 py-12 space-y-24">
      {/* FAQ Header Section */}
      <div className="w-full flex flex-col lg:flex-row gap-10">
        <h2 className="w-full lg:w-1/2 text-center lg:text-left font-museomoderno font-semibold text-4xl md:text-4xl lg:text-5xl xl:text-[50px] text-black">
          Frequently asked questions?
        </h2>
        <p className="w-full lg:w-1/2 font-light text-gray-500">
          We understand you may have questions! Below are answers to some of the
          most common inquiries about our prize draws, ticket purchases, and
          more.
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto mr-0">
        <Collapse
          items={faqData}
