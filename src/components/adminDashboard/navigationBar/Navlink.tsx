...
import { useLogoutMutation } from "@/redux/feature/api/authApi";
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="mt-auto px-4 space-y-1">
        <button
          ...
          disabled={isLoading}
          className={`flex items-center font-museomoderno gap-3 px-3 py-3 rounded-md cursor-pointer text-black font-bold text-lg hover:text-red-500 ${
